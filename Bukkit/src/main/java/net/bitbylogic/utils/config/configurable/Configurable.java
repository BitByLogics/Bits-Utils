package net.bitbylogic.utils.config.configurable;

import lombok.NonNull;
import lombok.Setter;
import net.bitbylogic.utils.Pair;
import net.bitbylogic.utils.config.configurable.data.ConfigKeyData;
import net.bitbylogic.utils.config.configurable.wrapper.ConfigWrapper;
import net.bitbylogic.utils.config.configurable.wrapper.impl.DefaultConfigWrapper;
...
public class Configurable {
    ...
    public void loadConfigPaths() {
        ...
        configValues.forEach((data, object) -> {
            ...
            ConfigWrapper wrapper = wrapperId.isEmpty() ? DEFAULT_WRAPPER
